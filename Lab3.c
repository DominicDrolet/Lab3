   ...
   while (idx < numUsbDevs)
   {
      ...
      if (devDesc.bDescriptorType > 0)
      {
         ...
         printf ("   string = %s\n", strDesc);
	  	  ...
	  	  //==================================================================
      // Get string associated with bDeviceClass index.
      //==================================================================
      ...
      if (devDesc.bDeviceClass > 0)
      {
         ...
         printf ("   string = %s\n", strDesc);
	  	  ...
	  	  //==================================================================
      // Get string associated with bDeviceProtocol index.
      //==================================================================
      ...
      if (devDesc.bDeviceProtocol > 0)
      {
         ...
         printf ("   string = %s\n", strDesc);
	  	  	  ...
	  	  	  //==================================================================
      // Get string associated with bDeviceSubClass index.
      //==================================================================
	  ...
	  //==================================================================
      // Get string associated with idProduct index.
      //==================================================================

      printf ("   idProduct = %d\n", devDesc.idProduct);
	  //==================================================================
      // Get string associated with idVendor index.
      //==================================================================

      printf ("   idVendor = %d\n", devDesc.idVendor);

	  //==================================================================
      // Get string associated with bcdDevice index.
      //==================================================================

      printf ("   bcdDevice = %d\n", devDesc.bcdDevice);

	  //==================================================================
      // Get string associated with bcdUSB index.
      //==================================================================

      printf ("   bcdUSB = %d\n", devDesc.bcdUSB);

	  	  	  	  //==================================================================
      // Get string associated with bNumConfigurations index.
      //==================================================================
	  ...
	  //==================================================================
      // Get string associated with bMaxPacketSize index.
      //==================================================================
